...
public class CookieManager {
    ...
    // Request Header에서 특정 쿠키를 획득(null이 올수있어서 Optional 반환)
    ...
    // 쿠키 생성 메소드
    public void setCookies(HttpServletResponse response, String name, String value, int maxAge, String path){
        ...
        cookie.setHttpOnly(true); // XSS 공격 방지 설정 HTTPOnly 설정
